...
LC_ALL=C DEBIAN_FRONTEND=noninteractive apt-get update &&  \
    ...
    libsqlite3-mod-spatialite libzip-dev lighttpd locales ninja-build pkg-config \
    poppler-utils pyqt5-dev pyqt5-dev-tools pyqt5.qsci-dev python3-all-dev \
    python3-dateutil python3-dev python3-future python3-gdal python3-httplib2 \
    python3-jinja2 python3-markupsafe python3-mock python3-nose2 python3-owslib \
    python3-plotly python3-psycopg2 python3-pygments python3-pyproj python3-pyqt5 \
    python3-pyqt5.qsci python3-pyqt5.qtsql python3-pyqt5.qtsvg python3-requests \
    python3-sip python3-sip-dev python3-six python3-termcolor python3-tz \
